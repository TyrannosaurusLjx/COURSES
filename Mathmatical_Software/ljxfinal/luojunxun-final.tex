...
\end{tikzpicture}
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale = 0.8]{Mandelbrot-set.eps}
    \end{figure}
    ...
    \begin{figure}[htbp]
        ...
        \centering
        \includegraphics[width=6cm]{julia with c = (-0.8+0.156j).eps}
        \caption{-0.8+0.156i}
        \end{minipage}
        \begin{minipage}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=6cm]{julia with c = (0.11+0.66j).eps}
        \caption{0.11+0.66i}
        \end{minipage}
    \end{figure}
    \par
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[scale = 0.6]{julia with c = (0.188+0.78603j).eps}
