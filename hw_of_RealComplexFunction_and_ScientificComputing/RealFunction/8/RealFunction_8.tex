...
\begin{figure}[p]
    ...
    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{R-8-1.jpg}}
...
\begin{figure}[p]
    ...
    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{R-8-2.jpg}}
