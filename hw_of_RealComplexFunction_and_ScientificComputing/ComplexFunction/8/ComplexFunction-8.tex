...
\begin{figure}[p]
    ...
    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{ComplexFunction-8-1.jpg}}

\end{figure}

\begin{figure}[p]

    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{ComplexFunction-8-2.jpg}}
