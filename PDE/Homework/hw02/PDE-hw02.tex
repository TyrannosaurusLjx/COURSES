...
\begin{figure}[p]
     \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{PDE-hw02-01.jpg}}
%     \caption{课上习题}
%     \label{figure}
\end{figure}
...
\begin{figure}[p]
     \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{PDE-hw02-02.jpg}}
%     \caption{课上习题}
%     \label{figure}
\end{figure}
