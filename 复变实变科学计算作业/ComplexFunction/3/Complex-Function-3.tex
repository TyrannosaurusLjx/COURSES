...
\begin{figure}[p]
    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{Complex-Function-3-1.jpg}}
\end{figure}
...
\begin{figure}[p]
    \centerline{\includegraphics[width=1.2\linewidth,height=1.1\textheight]{Complex-Function-3-3.jpg}}
\end{figure}
